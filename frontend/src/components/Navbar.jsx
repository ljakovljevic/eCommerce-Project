...
const Navbar = () => {
    ...
    const {setShowSearch, cartCount, cartItems, isAuthenticated, setIsAuthenticated, navigate } = useContext(ShopContext);
    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group  relative'>
            <div to='/login'><img src={assets.profile_icon} className='w-5 cursor-pointer' alt="" /></div>
